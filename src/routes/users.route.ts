import { addBalance, createUserTransaction, getBalance, getUserDetails, getUserTransactions } from "../controllers/users.controller";
...
router.route("/addBalance/haan").get(addBalance);
